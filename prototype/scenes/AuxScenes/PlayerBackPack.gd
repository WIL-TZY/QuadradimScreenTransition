...
func _on_DiaryPopAnimation_animation_started():
	$BackPack/BackPackButton.visible = false
	
func _on_DiaryHideAnimation_animation_started():
	$BackPack/BackPackButton.visible = false
	
func _on_DiaryHideAnimation_animation_finished():
	$DiaryInventory.visible = false
	$BackPack/BackPackButton.visible = true

func _on_DiaryPopAnimation_animation_finished():
	$BackPack/BackPackButton.visible = true

func _on_BackPackBeating_animation_finished():
